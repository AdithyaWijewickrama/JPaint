...
public class ImageVeiwerDialog extends javax.swing.JDialog {

    public static final String IMAGEPATH = "src\\Images\\ImageVeiwer ico.png";
    public static final ImageIcon FRAMEICON = new ImageIcon(IMAGEPATH);
    ...
    public ImageVeiwerDialog(ImageIcon img, String filename) {
        setMaxCropes(3);
        setIconImage(ImageVeiwerDialog.FRAMEICON.getImage());
...
//        setSliders();
    ...
    public static void main(String args[]) {
        try {
            ...
            Logger.getLogger(ImageVeiwerDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImageIcon img = new ImageIcon("Images Of Students\\1.png");
                ImageVeiwerDialog iv = new ImageVeiwerDialog(img, new File("Images Of Students\\1.png").getAbsolutePath());
                iv.setVisible(true);
